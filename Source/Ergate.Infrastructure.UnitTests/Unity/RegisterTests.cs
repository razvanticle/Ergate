namespace Ergate.Infrastructure.UnitTests.Unity
{
    ...
    public class RegisterTests
	{
		...
		{
			this.emptyInjectionMembers = new InjectionMember[] {};
		}
		...
		public void RegisterType_FromIsNull_RegistrationMadeWithToType()
		{
			...
			container.RegisterType(null, to, (string) null, this.emptyInjectionMembers);
		...
		public void RegisterType_ToIsNull_ArgumentNullException()
		{
			...
			Action act = () => container.RegisterType(@from, null, (string) null, this.emptyInjectionMembers);
		...
		public void RegisterType_FromIsAnInterfaceOfTo_RegistrationMade()
		{
			...
			container.RegisterType(typeof (ISomeInterface), typeof (SomeInterfaceImp), (string) null, this.emptyInjectionMembers);
		...
		public void RegisterType_ToDoesNotInheritFrom_ExceptionExpected()
		{
			...
			Action act = () =>
				container.RegisterType(typeof (SomeInterfaceImp), typeof (SomeBaseClass), "", this.emptyInjectionMembers);
		...
		public void RegisterType_FromIsNotAbstractButToInheritsIt_RegistrationIsCorrect()
		{
			...
			container.RegisterType(typeof (SomeBaseClass), typeof (SomeSubClass), "", this.emptyInjectionMembers);
